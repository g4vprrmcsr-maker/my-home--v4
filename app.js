...
const DEF={
 ...
 model:{provider:'Kiro',pid:'kiro',id:'claude-opus-4-8',name:'claude-opus-4-8'},
 convs:[],cur:null
};
let S;
function load(){try{S=JSON.parse(localStorage.getItem('kelivo'))}catch(e){S=null}
...
const stamp=d=>{d=d||new Date();const p=n=>String(n).padStart(2,'0');return `${d.getFullYear()}-${p(d.getMonth()+1)}-${p(d.getDate())} ${p(d.getHours())}:${p(d.getMinutes())}:${p(d.getSeconds())}`;};
...
const IC={
 ...
 book:'<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4v16a1 1 0 0 0 1 1h15M4 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v14H6a2 2 0 0 0-2 2"/></svg>',
 zap:'<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2 3 14h9l-1 8 10-12h-9Z"/></svg>',
 layers:'<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 2 10 5-10 5L2 7Z"/><path d="m2 12 10 5 10-5M2 17l10 5 10-5"/></svg>',
 ...
 caseS:'<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 15 4-8 4 8M4 13h6M21 9v6M21 9a3 3 0 0 0-3 3 3 3 0 0 0 3 3"/></svg>',
 settings2:'<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 7h-9M14 17H5M17 20a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM7 10a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/></svg>',
...
function assistantRow(m,i){
 ...
 if(st.showModelName)col.appendChild(el('span','msg-name',esc(nameTxt)+(st.showProviderName?` · ${esc(S.model.provider)}`:'')));
